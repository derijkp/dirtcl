...
download_ccompile http://www.openssl.org/source/openssl-1.0.1g.tar.gz
download_compile ftp://xmlsoft.org/libxml2/libxml2-2.7.8.tar.gz
download_ccompile ftp://ftp.csx.cam.ac.uk/pub/software/programming/pcre/pcre-8.20.tar.gz
