...
mkdir bin
ln -s /usr/bin/gcc34 bin/gcc
PATH=~/extern/crosstool-0.43/bin:/home/peter/apps/make3.81/bin:$PATH ./demo-x86_64.sh

}

# crosscompile all dependencies needed 
...
set env(ARCHITECTURE) i686
#set env(ARCHITECTURE) x86_64
set env(TARGET) "$env(ARCHITECTURE)-unknown-linux-gnu"
...
set env(BASE) ~/extern/deps-$env(ARCHITECTURE)-$env(CROSSTARGET)
...
catch {file delete -force {*}[glob ~/tcl/dirtcl-i686-gcc-3.3.6-glibc-2.3.2/*]}
file mkdir ~/tcl/dirtcl-i686-gcc-3.3.6-glibc-2.3.2
cd ~/tcl
exec ln -s dirtcl-i686-gcc-3.3.6-glibc-2.3.2 dirtcl
cd ~/tcl/dirtcl
